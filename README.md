...
This repository contains implementation of DDPG agent which tries to solve [Reacher](https://github.com/Unity-Technologies/ml-agents/blob/master/docs/Learning-Environment-Examples.md#reacher) environment.
...
### Instructions
1. Head on to [experiment notebook](reacher1.ipynb), run experiment training or load trained agent from disk and evaluate it.
